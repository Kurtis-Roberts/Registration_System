            ...
            <ul class="navbar-nav">
                <li class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdownMenuLink">
                        <a class="dropdown-item" href="studentInfo.php">Update Advisor Information</a>
    ...
    <div class="page-header header container-fluid">
        ...
        <div class="container">
            <div class="form-container">
                ...
                <!-- Student Info Form -->
                <form method='post' action='add_advisor.php'>
                    <div class="form-row">
...
if (
    ...
    $lname = $_POST['Lname'];
    echo $state;
    $query = "INSERT into Advisor (Advisor_ID, Fname, Lname)
				VALUES ($Advisor_ID, '$fname', '$lname');";
